...
# placeholder figure
mainfig = figure(tools="pan,box_zoom,reset,resize,previewsave,lasso_select", width=1200)


desc = bokeh.models.Div(
    text=open(path.join(path.dirname(__file__), "description.html")).read(), width=800
)
...
L = layouts.layout([[desc], [toprow], [mainfig], [bottomrow]], sizing_mode=SIZING_MODE)
